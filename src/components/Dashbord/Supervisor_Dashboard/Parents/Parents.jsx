...
console.log(Parents)
  ...
  const formConfig_Add={
    ...
    validationSchema: {
        fatherName: Yup.string().required("هذا الحقل مطلوب").matches(/^[a-zA-Z\u0600-\u06FF\s]+$/, 'غير مسموح باستخدام هذا المحرف  في هذا الحقل')
        .max(30,"لا يجب ان يكون الحقل أطول").min(3,"لا يجب أن يكون الحقل  أقصر"),
        motherName: Yup.string().required("هذا الحقل مطلوب").matches(/^[a-zA-Z\u0600-\u06FF\s]+$/, 'غير مسموح باستخدام هذا المحرف  في هذا الحقل')
        .max(30,"لا يجب ان يكون الحقل أطول").min(3,"لا يجب أن يكون الحقل  أقصر"),
